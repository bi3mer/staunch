...
int main(void)
{
    ...
    {
        s_exam_begin("s_radian_to_degree32");
        // zero
        {
            Radian32 rad = {0.0f};
    ...
    {
        s_exam_begin("s_degree_to_radian32");
        // zero
        {
            Degree32 deg = {0.0f};
    ...
    {
        s_exam_begin("s_radian_to_degree64");
        // zero
        {
            Radian64 rad = {0.0};
    ...
    {
        s_exam_begin("s_degree_to_radian64");
        // zero
        {
            Degree64 deg = {0.0};
