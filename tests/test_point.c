...
int main(void)
{
    ...
    // s_point_clone_f64
    {
        s_exam_begin("s_point_clone_f64");
    ...
    // s_point_equals_f64
    {
        s_exam_begin("s_point_equals_f64");
    ...
    // s_point_is_zero_f64
    {
        s_exam_begin("s_point_is_zero_f64");
    ...
    {
        s_exam_begin("s_point_zero_out_f64");
    ...
    {
        s_exam_begin("s_point_magnitude_f64");
    ...
    {
        s_exam_begin("s_point_magnitude_squared_f64");
    ...
    {
        s_exam_begin("s_point_normalize_f64");
    ...
    {
        s_exam_begin("s_point_normalize_in_f64");
    ...
    // s_point_scale_f64
    {
        s_exam_begin("s_point_scale_f64");
    ...
    {
        s_exam_begin("s_point_scale_in_f64");
    ...
    // s_point_divide_f64
    {
        s_exam_begin("s_point_divide_f64");
    ...
    {
        s_exam_begin("s_point_divide_in_f64");
    ...
    {
        s_exam_begin("s_point_multiply_f64");
    ...
    {
        s_exam_begin("s_point_multiply_in_f64");
    ...
    // s_point_add_in_f64
    {
        s_exam_begin("s_point_add_in_f64");
    ...
    {
        s_exam_begin("s_point_add_scaled_in_f64");
    ...
    {
        s_exam_begin("s_point_subtract_f64");
    ...
    {
        s_exam_begin("s_point_subtract_in_f64");
    ...
    {
        s_exam_begin("s_point_subtract_scaled_in_f64");
