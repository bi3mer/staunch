...
int main(void)
{
    ...
    S_EXAM("s_da_append")
    {
        ...
        // Append with struct
        {
            ...
            v2->x = 3.5f;
            v2->y = 4.5f;
            s_assert(s_da_length(da) == 2);
            s_assert(da[0].x == 1.5f && da[0].y == 2.5f);
            s_assert(da[1].x == 3.5f && da[1].y == 4.5f);
            s_da_cleanup(da);
        }
    }
